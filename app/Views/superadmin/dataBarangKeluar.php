      ...
      <div class="modal-body">
        <form action="<?= base_url('databarang/insert');?>" class="form-group" method="POST">
            ...
            <select name="nama_barang" id="" class="form-control">
                ...
                <?php 
                foreach($barangMasuk as $bs){?>
                <option value="<?= $bs['nama_barang'];?>"><?= $bs['nama_barang'];?></option>    
            <?php } ?>
            </select>
            <label for="status_barang">Status Barang</label>
            <select name="status_barang" id="" class="form-control" readonly>
                <option value="" selected disabled>--Pilih--</option>
            ...
            <input type="number" name="stok" class="form-control" placeholder="0" readonly>
            <label for="rak">Rak</label>
            <input type="text" name="rak" class="form-control" placeholder="Input disini" readonly>
            <label for="Toko">Toko</label>
            <input type="text" name="toko" class="form-control" placeholder="Input disini" readonly>
      </div>
